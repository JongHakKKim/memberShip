...
public class MemberShipService implements UserDetailsService {
    ...
    // 그런데 마약에 회원이 가입이 되어있으면 어쩔꺼임??

    public MemberShipDTO savaMember (MemberShipDTO memberShipDTO) {
    ...
    // 로그인  // UserDetailsServicefmf rngusgotj tkdydgksek
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        // try catch문으로 다른화면으로 덜리던 메세지를 가지고 로그인창으로 보내면 컨트롤러 창에서 알아서 해주겠지
        // 미래의 내가
        if(memberShip == null) {
